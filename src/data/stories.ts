...
export const stories: Story[] = [
  {
    ...
    content: {
      ...
      arabic: [
        "كان يا ما كان، كانت هناك فتاة صغيرة حلوة. صنعت لها جدتها غطاء رأس أحمر، فسماها الجميع ذات الرداء الأحمر.",
        "في يوم من الأيام، قالت أمها: \"خذي هذه السلة من الطعام إلى جدتك. إنها مريضة. لا تتحدثي مع الغرباء واذهبي مباشرة إلى منزلها.\"",
        "مشت ذات الرداء الأحمر عبر الغابة. في الطريق، قابلت ذئبا كبيرا وشريرا. قال لها: \"إلى أين أنت ذاهبة، يا فتاة صغيرة؟\"",
        "قالت: \"إلى بيت جدتي. إنها مريضة.\"",
        "ابتسم الذئب وقال: \"أتمنى لها الشفاء.\" ثم ركض بسرعة إلى بيت الجدة.",
        "طرق الذئب الباب. قالت الجدة: \"من هناك؟\"",
        "جعل الذئب صوته ناعما وقال: \"إنها أنا، ذات الرداء الأحمر.\"",
        "قالت الجدة: \"تفضلي بالدخول.\"",
        "قفز الذئب إلى الداخل، وأغلق على الجدة في الخزانة، ولبس ملابسها.",
        "بعد قليل، وصلت ذات الرداء الأحمر. نظرت إلى \"جدتها\" وقالت: \"جدتي، ما أكبر عينيك!\"",
        "قال الذئب: \"لكي أراك بشكل أفضل!\"",
        "قالت: \"ما أكبر أذنيك!\"",
        "قال: \"لكي أسمعك بشكل أفضل!\"",
        "قالت: \"ما أكبر أسنانك!\"",
        "صرخ الذئب: \"لكي آكلك!\" وقفز من السرير.",
        "صرخت ذات الرداء الأحمر. سمعها صياد قريب. ركض إلى الداخل، وأمسك بالذئب، وأنقذ الفتاة وجدتها.",
        "كانوا في أمان وسعادة. ومن ذلك اليوم، لم تتحدث ذات الرداء الأحمر مع الغرباء أبدا."
      ]
    }
  },
  {
    ...
    content: {
      english: [
        ...
        "A kind man had found it and turned it in to the security desk.",
        "Sara thanked him and smiled with relief."
      ],
      arabic: [
        "سارة كانت تمشي في المول عندما لاحظت أن جوالها كان مفقود.",
        "نظرت حولها وسألت حارس الأمن للمساعدة.",
        "رجل طيب كان قد وجده وسلمه إلى مكتب الأمن.",
        "شكرت سارة الرجل وابتسمت بارتياح."
      ]
    }
  },
  {
    ...
    content: {
      ...
      arabic: [
        "كان يا ما كان، هناك ثلاثة خنازير صغيرة قرروا أن يبنوا بيوتا لأنفسهم.",
        "الخنزير الأول بنى بيتا من القش لأنه كان سهلا وسريعا.",
        "الخنزير الثاني بنى بيتا من الخشب، والذي كان أقوى قليلا من القش.",
        "الخنزير الثالث عمل بجد وبنى بيتا قويا من الطوب.",
        "جاء ذئب كبير وشرير إلى بيت الخنزير الأول وقال: \"سأنفخ وأنفخ وسأهدم بيتك!\"",
        "نفخ الذئب بقوة، وانهار بيت القش. ركض الخنزير الأول إلى بيت أخيه الخشبي.",
        "تبع الذئب وهدم البيت الخشبي أيضا. ركض الخنزيران إلى بيت أخيهما الطوبي.",
        "حاول الذئب أن يهدم بيت الطوب، لكنه كان قويا جدا. أصبح الذئب غاضبا جدا.",
        "قرر الذئب أن يدخل عبر المدخنة. عندما تسلق للأسفل، سقط في قدر من الماء المغلي.",
        "صرخ الذئب وهرب بعيدا، ولم يعد أبدا.",
        "عاش الخنازير الثلاثة بسعادة وأمان بعد ذلك، وتعلموا أن العمل الجاد يحقق نتائج جيدة."
      ]
    }
  },
  {
    ...
    content: {
      ...
      arabic: [
        ...
        "علّم الله آدم الأسماء كلها، ثم أمر الملائكة أن يسجدوا له. سجدوا كلهم إلا إبليس.",
        ...
        "كان آدم أول إنسان، وأول نبي. ومنه بدأت حياة البشر."
      ]
    }
  },
  {
    ...
    content: {
      ...
      arabic: [
        "في زمن قديم، أرسل الله ملاكاً إلى مريم. قال لها الملاك: \"أنتِ مباركة، والله اختارك. ستلدين ولداً، وستسمينه يسوع. سيكون ابن الله.\"",
        "تعجبت مريم، وقالت: \"كيف يمكن أن يكون هذا؟\"",
        "قال الملاك: \"الروح القدس سيحل عليك، وقوة الله ستظللك. لذلك سيكون المولود قدوساً.\"",
        "آمنت مريم بكلام الملاك. بعد فترة، سافرت مع يوسف إلى بيت لحم. هناك ولد يسوع في مذود بسيط، لأنه لم يكن هناك مكان في الفندق.",
        "رأى رعاة في الحقل ملاكاً، وقال لهم: \"ولد لكم مخلص، هو المسيح!\" وجاؤوا ليروا الطفل، وفرحوا فرحاً عظيماً.",
        "كبر يسوع، وأصبح معلماً للناس عن محبة الله. شفى المرضى، وغفر الخطايا، وصنع معجزات كثيرة.",
        "ثم، كثير من الناس لم يعجبهم كلامه، فقبضوا عليه، وصلبوه على صليب. مات، ودفن في قبر.",
        "لكن بعد ثلاثة أيام، قام من الموت. ظهر لتلاميذه، وقال لهم: \"أنا حي، واذهبوا علموا كل الناس عني.\"",
        "هذا هو يسوع، المخلص الذي يحب كل الناس، وجاء ليعطيهم حياة أبدية."
      ]
    }
  },
  {
